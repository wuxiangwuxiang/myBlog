...
public class UserController {
	...
	public void updateUserInfo(@RequestParam(value = "userid", required = false) Integer userid,
			...
			@RequestParam(value = "userbirthday", required = false) Date userbirthday, HttpSession session) {
		Integer uid = (Integer) session.getAttribute("userid");
		/*
		 * System.out.println(username + "+" + usermobile + "+" + usergender + "+" +
		 * useraddress + "+" + useremail + "+" + userbirthday);
		 */
		userService.updateUserInfo(uid, username, usermobile, usergender, useraddress, useremail, userbirthday);
